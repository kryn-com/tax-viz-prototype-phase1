...
from models.ltcg_qd_sliver import (
    LTCGQDSliverCompositionResult,
    LTCGQDSliverDeltas,
)
...
def compose_additional_ltcg_qd_income_sliver(
    baseline_scenario: TaxScenarioInput,
    additional_ltcg_qd_income: float,
) -> LTCGQDSliverCompositionResult:
    if additional_ltcg_qd_income <= 0:
        raise ValueError("Additional LTCG/QD income must be greater than zero.")
    ...
    altered_scenario = _copy_with_updates(
        ...
        {
            "ltcg_qd_income": (
                baseline_scenario.ltcg_qd_income + additional_ltcg_qd_income
            ),
        },
    )
    ...
    return LTCGQDSliverCompositionResult(
        result_kind="ltcg_qd_sliver",
        additional_ltcg_qd_income=additional_ltcg_qd_income,
